...
/**
 * Объединяет строку с курсором со следующей (Волкова Екатерина)
 *
 * @param txt текст
 * @returns код возврата (0 при успехе, -1 при ошибке)
 */
...
/**
 * Перемещает курсор в заданную позицию текущей строки, если это возможно (Волкова Екатерина)
 * 
 * @param txt текст
 * @param arg позиция курсора
 * @returns код возврата (0 при успехе, -1 при ошибке)
 */
